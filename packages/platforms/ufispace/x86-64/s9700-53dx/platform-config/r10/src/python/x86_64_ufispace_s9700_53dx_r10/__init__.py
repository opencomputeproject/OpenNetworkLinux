...
class OnlPlatform_x86_64_ufispace_s9700_53dx_r10(OnlPlatformUfiSpace):
    PLATFORM='x86-64-ufispace-s9700-53dx-r10'
    MODEL="S9700-53DX"
    SYS_OBJECT_ID=".9700.53"
    PORT_COUNT=53
    PORT_CONFIG="40x100 + 13x400"
     
    def check_bmc_enable(self):
        return 1

    def check_i2c_status(self): 
        sysfs_mux_reset = "/sys/devices/platform/x86_64_ufispace_s9700_53dx_lpc/cpu_cpld/mux_reset"
    ...
    def baseconfig(self):
        ...
        # lpc driver
        self.insmod("x86-64-ufispace-s9700-53dx-lpc")
        ...
        #CPLD
        self.insmod("x86-64-ufispace-s9700-53dx-cpld")
        for i, addr in enumerate((0x30, 0x39, 0x3a, 0x3b, 0x3c)):
            self.new_i2c_device("s9700_53dx_cpld" + str(i+1), addr, 1)
        ...
        # onie syseeprom
        self.insmod("x86-64-ufispace-s9700-53dx-onie-syseeprom.ko")
