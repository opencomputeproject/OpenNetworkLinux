...
onlp_sysi_platform_get(void)
{
    ...
    if (read_ioport(mb_cpld1_addr, &mb_cpld1_board_type_rev) < 0) {
        ...
        return "x86-64-ufispace-s9700-23d-rx";
    }
