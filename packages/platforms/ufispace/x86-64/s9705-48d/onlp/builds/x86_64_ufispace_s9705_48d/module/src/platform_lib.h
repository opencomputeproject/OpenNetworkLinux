...
#define MB_CPLD1_ID_PATH            "/sys/bus/i2c/devices/2-0030/cpld_id"
#define CPU_MUX_RESET_PATH          "/sys/devices/platform/x86_64_ufispace_s9705_48d_lpc/cpu_cpld/mux_reset"
...
typedef enum thermal_oid_e {
    ...
    THERMAL_OID_RAMON_ENV_T = ONLP_THERMAL_ID_CREATE(2),    
    THERMAL_OID_RAMON_DIE_T = ONLP_THERMAL_ID_CREATE(3),
    THERMAL_OID_RAMON_ENV_B = ONLP_THERMAL_ID_CREATE(4),
    THERMAL_OID_RAMON_DIE_B = ONLP_THERMAL_ID_CREATE(5),
    THERMAL_OID_PSU0 = ONLP_THERMAL_ID_CREATE(6),
    THERMAL_OID_PSU1 = ONLP_THERMAL_ID_CREATE(7),
    THERMAL_OID_CPU_PKG = ONLP_THERMAL_ID_CREATE(8),    
    THERMAL_OID_CPU1 = ONLP_THERMAL_ID_CREATE(9),
    THERMAL_OID_CPU2 = ONLP_THERMAL_ID_CREATE(10),
    THERMAL_OID_CPU3 = ONLP_THERMAL_ID_CREATE(11),
    THERMAL_OID_CPU4 = ONLP_THERMAL_ID_CREATE(12), 
    THERMAL_OID_CPU5 = ONLP_THERMAL_ID_CREATE(13), 
    THERMAL_OID_CPU6 = ONLP_THERMAL_ID_CREATE(14), 
    THERMAL_OID_CPU7 = ONLP_THERMAL_ID_CREATE(15), 
    THERMAL_OID_CPU8 = ONLP_THERMAL_ID_CREATE(16),  
    THERMAL_OID_CPU_BOARD = ONLP_THERMAL_ID_CREATE(17),
    THERMAL_OID_BMC_ENV = ONLP_THERMAL_ID_CREATE(18),
    THERMAL_OID_ENV_FRONT_T = ONLP_THERMAL_ID_CREATE(19),
    THERMAL_OID_ENV_FRONT_B = ONLP_THERMAL_ID_CREATE(20),
} thermal_oid_t;

/** thermal_id */
typedef enum thermal_id_e {
    THERMAL_ID_CPU_PECI = 1,    
    THERMAL_ID_RAMON_ENV_T = 2,
    THERMAL_ID_RAMON_DIE_T = 3, 
    THERMAL_ID_RAMON_ENV_B = 4,
    THERMAL_ID_RAMON_DIE_B = 5,      
    THERMAL_ID_PSU0 = 6, 
    THERMAL_ID_PSU1 = 7,
    THERMAL_ID_CPU_PKG = 8,
    THERMAL_ID_CPU1 = 9,
    THERMAL_ID_CPU2 = 10,
    THERMAL_ID_CPU3 = 11,
    THERMAL_ID_CPU4 = 12,
    ...
    THERMAL_ID_CPU7 = 15,
    THERMAL_ID_CPU8 = 16,
    THERMAL_ID_CPU_BOARD = 17,  
    THERMAL_ID_BMC_ENV = 18,
    THERMAL_ID_ENV_FRONT_T = 19,
    THERMAL_ID_ENV_FRONT_B = 20,
    THERMAL_ID_MAX = 21,
} thermal_id_t;
