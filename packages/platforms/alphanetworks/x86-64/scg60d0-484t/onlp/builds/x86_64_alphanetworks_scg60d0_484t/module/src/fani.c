...
_onlp_fani_info_get_fan_on_psu(int pid, onlp_fan_info_t* info)
{
    ...
    /* get fan speed
     */
    if (psu_dps550ab_pmbus_info_get(pid, "psu_fan1_speed_rpm", &val) == ONLP_STATUS_OK) {
        info->rpm = val;
...
onlp_fani_percentage_set(onlp_oid_t id, int p)
{
    ...
    {
    case FAN_1_ON_PSU_1:
        return psu_dps550ab_pmbus_info_set(PSU1_ID, "psu_fan1_duty_cycle_percentage", p);
    case FAN_1_ON_PSU_2:
        return psu_dps550ab_pmbus_info_set(PSU2_ID, "psu_fan1_duty_cycle_percentage", p);
