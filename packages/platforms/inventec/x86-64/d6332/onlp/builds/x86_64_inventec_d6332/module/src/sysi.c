...
#include "x86_64_inventec_d6332_int.h"
...
static onlp_oid_t __oid_info[] = {
    ...
    ONLP_LED_ID_CREATE(ONLP_LED_STK),
    ONLP_LED_ID_CREATE(ONLP_LED_FAN),
    ONLP_LED_ID_CREATE(ONLP_LED_PWR),
...
static int _sysi_version_parsing(char* file_str, char* str_buf, char* str_buf2, char* version)
{
    ...
    if (temp) {
        ...
        AIM_LOG_ERROR("[ONLP][SYS] Unable to parse cpld version\n");
...
{
    return "x86-64-inventec-d6332-r0";
}
