...
class OnlPlatform_x86_64_netberg_aurora_750_r0(OnlPlatformNetberg):
    PLATFORM = 'x86-64-netberg-aurora-750-r0'
    MODEL = "NBA750"
    SYS_OBJECT_ID = ".750.1"
    ...
    def baseconfig(self):
        ...
        os.system("i2cset -y -r 0 0x25 7 0xF3")
        ...
        self.insmod("netberg_aurora_750_i2c_cpld")

        # add cpld 1~5 to sysfs
        for i in range(1, 6):
            self.new_i2c_device('netberg_cpld%d' % i, 0x33, i)

        # _i2c_psu_init

        self.insmod("netberg_aurora_750_psu")
        ...
        # _mac_vdd_init
        rov_status_file = open(
            "/sys/bus/i2c/devices/1-0033/cpld_rov_status", "r")
