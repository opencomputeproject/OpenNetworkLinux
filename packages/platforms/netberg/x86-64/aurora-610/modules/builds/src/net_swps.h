...
struct nb_platform_s {
    int  id;
    char name[64];
};

struct nb_ioexp_layout_s {
    int ioexp_id;
    int ioexp_type;
    struct ioexp_addr_s addr[4];
};

struct nb_port_layout_s {
    int port_id;
    int chan_id;
    int ioexp_id;
    int ioexp_offset;
 ...
 * ==========================================
 */
struct nb_platform_s platform_map[] = {
    {PLATFORM_TYPE_AUTO,                 "Auto-Detect"         },
    {PLATFORM_TYPE_AURORA_610,  		 "Aurora 610" },
};
...
struct nb_ioexp_layout_s aurora_610_ioexp_layout[] = {
...
struct nb_port_layout_s aurora_610_port_layout[] = {
