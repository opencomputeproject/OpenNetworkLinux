...
#include "x86_64_netberg_aurora_820_int.h"
...
static onlp_oid_t __oid_info[] = {
    ...
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_6_ON_MAIN_BROAD),
    ONLP_THERMAL_ID_CREATE(ONLP_THERMAL_7_ON_MAIN_BROAD),
    ...
    ONLP_FAN_ID_CREATE(ONLP_FAN_9),
    ONLP_FAN_ID_CREATE(ONLP_FAN_10),
    ONLP_FAN_ID_CREATE(ONLP_FAN_11),
    ONLP_FAN_ID_CREATE(ONLP_FAN_12),
    ...
    ONLP_LED_ID_CREATE(ONLP_LED_FAN5),
    ONLP_LED_ID_CREATE(ONLP_LED_FAN6),
    0/*end*/
};
...
{
    return "x86-64-netberg-aurora-820-r0";
}
...
onlp_sysi_onie_data_get(uint8_t** data, int* size)
{
    ...
    FILE* fp  = fopen(NET_EEPROM_PATH, "rb");
...
onlp_sysi_onie_info_get (onlp_onie_info_t *onie)
{
    ...
    rv = onlp_onie_decode_file(onie, NET_EEPROM_PATH);
