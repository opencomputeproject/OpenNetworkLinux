...
MODULE_PARM_DESC(retrys, "UCD90160 read retry times (default 1).");
...
static int
net_ucd90160_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
...
static const struct i2c_device_id net_ucd90160_ids[] = {
	{ "net_ucd90160" , 0, },
	{ "net_ucd90160_cpu" , 0, },
	{ "net_ucd90160_switch" , 0, },
	{ "net_ucd90160_line" , 0, },
	{ /* LIST END */ }
};
MODULE_DEVICE_TABLE(i2c, net_ucd90160_ids);
...
static int __init net_ucd90160_init(void)
{
	return i2c_add_driver(&ucd90160_driver);
}

static void __exit net_ucd90160_exit(void)
{
	i2c_del_driver(&ucd90160_driver);
}

MODULE_AUTHOR("Netberg <support@netbergtw.com>");
MODULE_DESCRIPTION("ucd90160 driver");
MODULE_LICENSE("GPL");

module_init(net_ucd90160_init);
module_exit(net_ucd90160_exit);
