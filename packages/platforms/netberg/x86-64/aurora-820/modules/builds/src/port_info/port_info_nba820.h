...
#ifndef __PORT_INFO_CONFIG_NBA820
#define __PORT_INFO_CONFIG_NBA820

struct port_info_map_t nba820_port_info_map[] = {
...
struct port_info_table_t nba820_port_info_table = {
    .map =  nba820_port_info_map,
    .size = ARRAY_SIZE(nba820_port_info_map),
};

#endif /*__PORT_INFO_CONFIG_NBA820*/
