...
static int mp5023_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	return pmbus_do_probe(client, id, &mp5023_info);
}

static const struct i2c_device_id mp5023_id[] = {
	{"mp5023", 0},
	{}
};

MODULE_DEVICE_TABLE(i2c, mp5023_id);
