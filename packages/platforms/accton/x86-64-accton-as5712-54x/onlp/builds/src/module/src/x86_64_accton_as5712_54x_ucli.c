...
ucli_node_t*
x86_64_accton_as5712_54x_ucli_node_create(void)
{
    ucli_node_t* n;
    ucli_module_init(&x86_64_accton_as5712_54x_ucli_module__);
    n = ucli_node_create("x86_64_accton_as5712_54x", NULL, &x86_64_accton_as5712_54x_ucli_module__);
    ucli_node_subnode_add(n, ucli_module_log_node_create("x86_64_accton_as5712_54x"));
    return n;
}
