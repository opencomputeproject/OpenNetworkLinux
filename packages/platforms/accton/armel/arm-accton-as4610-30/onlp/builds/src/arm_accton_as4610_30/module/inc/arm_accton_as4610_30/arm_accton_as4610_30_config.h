 ...
 *
 * @file
 * @brief arm_accton_as4610_30 Configuration Header
 *
 * @addtogroup arm_accton_as4610_30-config
 * @{
 *
 *****************************************************************************/
...
#include <arm_accton_as4610_30_custom_config.h>
#endif
...
typedef struct arm_accton_as4610_30_config_settings_s {
    /** name */
    const char* name;
    /** value */
    const char* value;
} arm_accton_as4610_30_config_settings_t;

/** Configuration settings table. */
/** arm_accton_as4610_30_config_settings table. */
extern arm_accton_as4610_30_config_settings_t arm_accton_as4610_30_config_settings[];

/**
 * @brief Lookup a configuration setting.
 * @param setting The name of the configuration option to lookup.
 */
const char* arm_accton_as4610_30_config_lookup(const char* setting);

/**
 * @brief Show the compile-time configuration.
 * @param pvs The output stream.
 */
int arm_accton_as4610_30_config_show(struct aim_pvs_s* pvs);

/* <auto.end.cdefs(ONLPSIM_CONFIG_HEADER).header> */

#include "arm_accton_as4610_30_porting.h"
