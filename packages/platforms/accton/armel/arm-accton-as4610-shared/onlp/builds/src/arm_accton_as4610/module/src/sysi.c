...
{
    return "arm-accton-as4610-r0";
}

int
onlp_sysi_platform_set(const char* platform)
{
    if(strstr(platform, "arm-accton-as4610-30-r0")) {
        platform_id = PLATFORM_ID_POWERPC_ACCTON_AS4610_30_R0;
        return ONLP_STATUS_OK;
    }
    if(strstr(platform, "arm-accton-as4610-54-r0")) {
        platform_id = PLATFORM_ID_POWERPC_ACCTON_AS4610_54_R0;
        return ONLP_STATUS_OK;
    }
