...
#else
static int __init ocores_i2c_as9947_72xkb_init(void)
{
    int err;
...
static void __exit ocores_i2c_as9947_72xkb_exit(void)
{
    platform_driver_unregister(&ocores_i2c_driver);
}

module_init(ocores_i2c_as9947_72xkb_init);
module_exit(ocores_i2c_as9947_72xkb_exit);
#endif
