...
#define AS5916_THERMAL_CAPS (ONLP_THERMAL_CAPS_GET_TEMPERATURE | \
...
static onlp_thermal_info_t linfo[] = {
	...
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_CPU_CORE), "CPU Core", 0}, 
            ...
            AS5916_THERMAL_CAPS, 0, {95000, 95000, 100000}
        },
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_1_ON_MAIN_BROAD), "LM75_1 U39", 0},
            ONLP_THERMAL_STATUS_PRESENT,
            AS5916_THERMAL_CAPS, 0, {55000, 55000, 59000}
        },
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_2_ON_MAIN_BROAD), "LM75_2 U50", 0},
            ONLP_THERMAL_STATUS_PRESENT,
            AS5916_THERMAL_CAPS, 0, {55000, 55000, 59000}
        },
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_3_ON_MAIN_BROAD), "LM75_3 U35", 0},
            ONLP_THERMAL_STATUS_PRESENT,
            AS5916_THERMAL_CAPS, 0, {55000, 55000, 59000}
        },
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_4_ON_MAIN_BROAD), "LM75_Heater_CPU U20", 0},
            ONLP_THERMAL_STATUS_PRESENT,
            AS5916_THERMAL_CAPS, 0, {55000, 55000, 59000}
        },
