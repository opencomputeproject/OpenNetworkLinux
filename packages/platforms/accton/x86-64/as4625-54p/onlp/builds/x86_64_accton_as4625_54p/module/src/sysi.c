...
#include "x86_64_accton_as4625_54p_int.h"
...
#define SYS_TEMP_HIGH_THRESHOLD 202
#define SYS_TEMP_LOW_THRESHOLD 135
...
{
	return "x86-64-accton-as4625-54p-r0";
}
	...
	for(i = 1; i <= CHASSIS_FAN_COUNT; i++){
		if(fan_fail){
			...
			if(pwm_state == PWM_STATE_NORMAL)
				onlp_fani_percentage_set(ONLP_FAN_ID_CREATE(i), FAN_DUTY_CYCLE_DEFAULT);
