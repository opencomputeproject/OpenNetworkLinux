...
{
	return "x86-64-accton-es7632bt3-r0";
}
...
#define FAN_SPEED_CTRL_PATH \
	"/sys/bus/i2c/devices/55-0066/fan_duty_cycle_percentage"
#define FAN_DIRECTION_PATH "/sys/bus/i2c/devices/55-0066/fan1_direction"
