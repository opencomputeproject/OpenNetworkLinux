...
#include "x86_64_accton_es7632bt3_int.h"
...
#define MODULE_RXLOS_ALL_ATTR_CPLD \
	"/sys/bus/i2c/devices/12-0060/module_rx_los_all"
#define MODULE_RXLOS_ALL_ATTR_CPLD3 \
	"/sys/bus/i2c/devices/6-0064/module_rx_los_all"

int sfp_map_bus[] = { 22, 23, 24, 25, 27, 26, 29, 28,
...
int onlp_sfpi_is_present(int port)
{
	...
	if (onlp_file_read_int(&present, MODULE_PRESENT_FORMAT, bus, addr, 
			       (port+1)) < 0) {
