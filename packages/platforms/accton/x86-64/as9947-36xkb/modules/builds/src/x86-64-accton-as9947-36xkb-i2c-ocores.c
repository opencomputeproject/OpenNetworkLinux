...
#define SPI_BUSY_ADDR                       (0xb3322000 + 0x30)
...
#else
static int __init ocores_i2c_as9947_36xkb_init(void)
{
    int err;
...
static void __exit ocores_i2c_as9947_36xkb_exit(void)
{
...
module_init(ocores_i2c_as9947_36xkb_init);
module_exit(ocores_i2c_as9947_36xkb_exit);
#endif

MODULE_AUTHOR("Peter Korsgaard <peter@korsgaard.com>");
MODULE_DESCRIPTION("OpenCores I2C bus driver");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:ocores-as9947");
