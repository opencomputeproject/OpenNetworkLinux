...
#define DRVNAME "as9947_36xkb_thermal"
...
static ssize_t show_temp(struct device *dev, struct device_attribute *attr,
    char *buf);
static int as9947_36xkb_thermal_probe(struct platform_device *pdev);
static int as9947_36xkb_thermal_remove(struct platform_device *pdev);
...
struct as9947_36xkb_thermal_data {
...
struct as9947_36xkb_thermal_data *data = NULL;

static struct platform_driver as9947_36xkb_thermal_driver = {
    .probe = as9947_36xkb_thermal_probe,
    .remove = as9947_36xkb_thermal_remove,
    .driver = {
        .name = DRVNAME,
        .owner = THIS_MODULE,
    },
...
enum as9947_36xkb_thermal_sysfs_attrs {
    TEMP1_INPUT, // 0x4F
    TEMP2_INPUT, // 0x4E
    TEMP3_INPUT, // 0x4A
    TEMP4_INPUT, // 0x4B
    TEMP5_INPUT, // 0x4C_LOCAL
    TEMP6_INPUT, // 0x4C_REMOTE
    TEMP7_INPUT, // 0x4D
    TEMP8_INPUT, // FAN 0x4D
    TEMP9_INPUT, // FAN 0x4E
};
...
static struct attribute *as9947_36xkb_thermal_attrs[] = {
...
ATTRIBUTE_GROUPS(as9947_36xkb_thermal);
...
static int as9947_36xkb_thermal_probe(struct platform_device *pdev)
{
    ...
    hwmon_dev = hwmon_device_register_with_info(&pdev->dev, DRVNAME, 
                    NULL, NULL, as9947_36xkb_thermal_groups);
...
static int __init as9947_36xkb_thermal_init(void)
{
    int ret;

    data = kzalloc(sizeof(struct as9947_36xkb_thermal_data), GFP_KERNEL);
    if (!data) {
        ret = -ENOMEM;
        goto alloc_err;
    }
    ...
    ret = platform_driver_register(&as9947_36xkb_thermal_driver);
    if (ret < 0)
        goto dri_reg_err;
...
static void __exit as9947_36xkb_thermal_exit(void)
{
    if (data) {
...
MODULE_DESCRIPTION("as9947_36xkb_thermal driver");
MODULE_LICENSE("GPL");

module_init(as9947_36xkb_thermal_init);
module_exit(as9947_36xkb_thermal_exit);
