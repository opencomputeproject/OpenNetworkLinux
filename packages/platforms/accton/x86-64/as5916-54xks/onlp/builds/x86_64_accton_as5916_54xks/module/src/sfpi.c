...
#define MODULE_RESET_FORMAT             "/sys/devices/platform/as5916_54xks_sfp/module_reset_%d"
#define MODULE_LPMODE_FORMAT            "/sys/devices/platform/as5916_54xks_sfp/module_lpmode_%d"
