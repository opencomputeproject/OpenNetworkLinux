			 ...
			 char *buf)
{
	...
	switch (attr->index) {
	case MODULE_TXDISABLE_25 ... MODULE_TXDISABLE_30:
		reg  = 0x5;
		mask = 0x1 << (attr->index - MODULE_TXDISABLE_25);
		break;
	case MODULE_PRESENT_25 ... MODULE_PRESENT_30:
		reg  = 0x6;
		mask = 0x1 << (attr->index - MODULE_PRESENT_25);
		reverse = 1;
		break;
	case MODULE_RXLOS_25 ... MODULE_RXLOS_30:
		reg  = 0x7;
		mask = 0x1 << (attr->index - MODULE_RXLOS_25);
		break;
	case MODULE_TXFAULT_25 ... MODULE_TXFAULT_30:
		reg  = 0x8;
