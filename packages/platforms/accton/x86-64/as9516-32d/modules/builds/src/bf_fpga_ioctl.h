...
#define BF_FPGA_I2C_WRITE 1 /* <i2c-addr-wr> / <wr-d0> <wr-d1>..[max 129 bytes] */
#define BF_FPGA_I2C_READ 2  /* <i2c-addr-rd> / <rd-d0> <rd-d1>..[max 128 bytes] */
#define BF_FPGA_I2C_ADDR_READ 3 /* <i2c-addr-wr> / <upto 4 bytes of register offset / <R/S> / \
...
typedef struct bf_fpga_i2c_inst_s {
        ...
        union {
                unsigned char wr_buf[BF_FPGA_MAX_I2C_WR_DATA]; /* write data source buffer */
...
#define BF_FPGA_IOCTL_I2C_RD_DATA _IOWR(BF_FPGA_IOC_MAGIC, 4, bf_fpga_i2c_rd_data_t)
#define BF_FPGA_IOCTL_I2C_SET_CLK _IOW(BF_FPGA_IOC_MAGIC, 5, bf_fpga_i2c_set_clk_t)
