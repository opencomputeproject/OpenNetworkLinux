...
#define SPI_BUSY_ADDR                       (0xb3c00000 + 0x33)
#define IOREMAP_SIZE                        (0x01)
...
#else
static int __init ocores_i2c_as7927_50x_init(void)
{
    int err;
...
static void __exit ocores_i2c_as7927_50x_exit(void)
{
...
module_init(ocores_i2c_as7927_50x_init);
module_exit(ocores_i2c_as7927_50x_exit);
#endif

MODULE_AUTHOR("Willy Liu <willy_liu@accton.com>");
MODULE_DESCRIPTION("OpenCores I2C bus driver");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:ocores-as7927");
