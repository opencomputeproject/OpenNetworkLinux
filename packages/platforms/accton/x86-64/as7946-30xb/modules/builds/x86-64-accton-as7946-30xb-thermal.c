...
#define DRVNAME "as7946_30xb_thermal"
...
struct as7946_30xb_thermal_data {
...
struct as7946_30xb_thermal_data *data = NULL;
...
enum as7946_30xb_thermal_sysfs_attrs {
	TEMP1_INPUT,
	TEMP2_INPUT,
	TEMP3_INPUT,
	TEMP4_INPUT,
...
static struct attribute *as7946_30xb_thermal_attributes[] = {
...
static const struct attribute_group as7946_30xb_thermal_group = {
	.attrs = as7946_30xb_thermal_attributes,
};
...
static int as7946_30xb_thermal_probe(struct platform_device *pdev)
{
	...
	status = sysfs_create_group(&pdev->dev.kobj, &as7946_30xb_thermal_group);
	if (status)
		goto exit;
...
static int __init as7946_30xb_thermal_init(void)
{
	...
	data = kzalloc(sizeof(struct as7946_30xb_thermal_data), GFP_KERNEL);
	if (!data) {
		ret = -ENOMEM;
		goto alloc_err;
	}
	...
	ret = platform_driver_register(&as7946_30xb_thermal_driver);
	if (ret < 0)
		goto dri_reg_err;
...
dev_reg_err:
	platform_driver_unregister(&as7946_30xb_thermal_driver);
dri_reg_err:
	kfree(data);
alloc_err:
	return ret;
...
static void __exit as7946_30xb_thermal_exit(void)
{
...
MODULE_DESCRIPTION("AS7946 30xb Thermal driver");
MODULE_LICENSE("GPL");

module_init(as7946_30xb_thermal_init);
module_exit(as7946_30xb_thermal_exit);
