...
static char* devfiles__[] =  /* must map with onlp_thermal_id */
{
    NULL,
    NULL,                  /* CPU_CORE files */
    "/sys/bus/i2c/devices/7-0048*temp1_input",
    "/sys/bus/i2c/devices/8-0049*temp1_input",
    "/sys/bus/i2c/devices/9-004a*temp1_input",
    "/sys/bus/i2c/devices/9-004b*temp1_input",
    "/sys/bus/i2c/devices/3-0058*psu_temp1_input",
    "/sys/bus/i2c/devices/4-0059*psu_temp1_input",	
};
