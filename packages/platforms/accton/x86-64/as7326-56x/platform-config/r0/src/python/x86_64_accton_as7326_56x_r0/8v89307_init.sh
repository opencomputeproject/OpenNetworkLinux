...
i2cset -y 9 0x54 0x2D 0x00 # Select to Page 0
...
i2cset -y 9 0x54 0x71 0x0A # OUT3:25MHz
i2cset -y 9 0x54 0x70 0x00
i2cset -y 9 0x54 0x6B 0x4E # OUT1:1pps
...
i2cset -y 9 0x54 0x55 0x80 # Lock to DPLL, output 625MHz
...
i2cset -y 9 0x54 0x23 0x05 #IN1
i2cset -y 9 0x54 0x24 0x03
i2cset -y 9 0x54 0x25 0x00
i2cset -y 9 0x54 0x23 0x06 #IN2
i2cset -y 9 0x54 0x24 0x03
i2cset -y 9 0x54 0x25 0x00
i2cset -y 9 0x54 0x23 0x03 #IN3
i2cset -y 9 0x54 0x24 0x00
i2cset -y 9 0x54 0x25 0x00

# Page1_Parameters
i2cset -y 9 0x54 0x2D 0x01 # Select to Page 1
i2cset -y 9 0x54 0x30 0x03
i2cset -y 9 0x54 0x31 0x08
i2cset -y 9 0x54 0x32 0x08
i2cset -y 9 0x54 0x33 0x08
...
i2cset -y 9 0x54 0x3C 0x13
i2cset -y 9 0x54 0x3D 0x20
i2cset -y 9 0x54 0x2D 0x00 # Return to Page 0
