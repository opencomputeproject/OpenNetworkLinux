...
class OnlPlatform_x86_64_accton_wedge100bf_32x_r0(OnlPlatformAccton,
    ...
    def baseconfig(self):
        ...
        subprocess.call('echo port2 > /sys/bus/i2c/devices/3-0050/port_name', shell=True)
        subprocess.call('echo port3 > /sys/bus/i2c/devices/4-0050/port_name', shell=True)
        subprocess.call('echo port4 > /sys/bus/i2c/devices/5-0050/port_name', shell=True)
        subprocess.call('echo port5 > /sys/bus/i2c/devices/6-0050/port_name', shell=True)
        subprocess.call('echo port6 > /sys/bus/i2c/devices/7-0050/port_name', shell=True)
        subprocess.call('echo port7 > /sys/bus/i2c/devices/8-0050/port_name', shell=True)
        subprocess.call('echo port8 > /sys/bus/i2c/devices/9-0050/port_name', shell=True)
        subprocess.call('echo port9 > /sys/bus/i2c/devices/10-0050/port_name', shell=True)
        subprocess.call('echo port10 > /sys/bus/i2c/devices/11-0050/port_name', shell=True)
        subprocess.call('echo port11 > /sys/bus/i2c/devices/12-0050/port_name', shell=True)
        subprocess.call('echo port12 > /sys/bus/i2c/devices/13-0050/port_name', shell=True)
        subprocess.call('echo port13 > /sys/bus/i2c/devices/14-0050/port_name', shell=True)
        subprocess.call('echo port14 > /sys/bus/i2c/devices/15-0050/port_name', shell=True)
        subprocess.call('echo port15 > /sys/bus/i2c/devices/16-0050/port_name', shell=True)
        subprocess.call('echo port16 > /sys/bus/i2c/devices/17-0050/port_name', shell=True)
        subprocess.call('echo port17 > /sys/bus/i2c/devices/18-0050/port_name', shell=True)
        subprocess.call('echo port18 > /sys/bus/i2c/devices/19-0050/port_name', shell=True)
        subprocess.call('echo port19 > /sys/bus/i2c/devices/20-0050/port_name', shell=True)
        subprocess.call('echo port20 > /sys/bus/i2c/devices/21-0050/port_name', shell=True)
        subprocess.call('echo port21 > /sys/bus/i2c/devices/22-0050/port_name', shell=True)
        subprocess.call('echo port22 > /sys/bus/i2c/devices/23-0050/port_name', shell=True)
        subprocess.call('echo port23 > /sys/bus/i2c/devices/24-0050/port_name', shell=True)
        subprocess.call('echo port24 > /sys/bus/i2c/devices/25-0050/port_name', shell=True)
        subprocess.call('echo port25 > /sys/bus/i2c/devices/26-0050/port_name', shell=True)
        subprocess.call('echo port26 > /sys/bus/i2c/devices/27-0050/port_name', shell=True)
        subprocess.call('echo port27 > /sys/bus/i2c/devices/28-0050/port_name', shell=True)
        subprocess.call('echo port28 > /sys/bus/i2c/devices/29-0050/port_name', shell=True)
        ...
        subprocess.call('echo port32 > /sys/bus/i2c/devices/33-0050/port_name', shell=True)
