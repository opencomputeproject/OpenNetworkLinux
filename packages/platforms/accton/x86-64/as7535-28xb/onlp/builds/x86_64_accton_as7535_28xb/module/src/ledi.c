...
#define LED_FORMAT "/sys/devices/platform/as7535_28xb_led/led_%s"
...
led_light_mode_map_t led_map[] = {
    ...
    {LED_PSU1,  LED_MODE_YELLOW,ONLP_LED_MODE_ORANGE},
    {LED_PSU2,  LED_MODE_OFF, ONLP_LED_MODE_OFF},
    {LED_PSU2,  LED_MODE_GREEN, ONLP_LED_MODE_GREEN},
    {LED_PSU2,  LED_MODE_YELLOW,ONLP_LED_MODE_ORANGE},
