...
static SENSOR_DEVICE_ATTR(module_present_65, S_IRUGO, status_read, NULL,
			  MODULE_PRESENT_65);
static SENSOR_DEVICE_ATTR(module_present_66, S_IRUGO, status_read, NULL,
			  MODULE_PRESENT_66);
...
static SENSOR_DEVICE_ATTR(module_tx_fault_65, S_IRUGO, status_read, NULL,
			  MODULE_TX_FAULT_65);
static SENSOR_DEVICE_ATTR(module_tx_fault_66, S_IRUGO, status_read, NULL,
			  MODULE_TX_FAULT_66);
static SENSOR_DEVICE_ATTR(module_rx_los_65, S_IRUGO, status_read, NULL,
			  MODULE_RX_LOS_65);
static SENSOR_DEVICE_ATTR(module_rx_los_66, S_IRUGO, status_read, NULL,
			  MODULE_RX_LOS_66);
static SENSOR_DEVICE_ATTR(cpld1_version, S_IRUGO, status_read, NULL,
			  CPLD1_VERSION);
static SENSOR_DEVICE_ATTR(cpld2_version, S_IRUGO, status_read, NULL,
			  CPLD2_VERSION);
static SENSOR_DEVICE_ATTR(cpld1_reg, S_IRUGO | S_IWUSR, reg_read, reg_write,
			  CPLD1_REG);
static SENSOR_DEVICE_ATTR(cpld2_reg, S_IRUGO | S_IWUSR, reg_read, reg_write,
			  CPLD2_REG);
...
static struct attribute_mapping attribute_mappings[] = {
	[MODULE_PRESENT_1 ... MODULE_PRESENT_8] =
	    {MODULE_PRESENT_1, XCVR_P7_P0_PRESENT_REG, 1},
	[MODULE_PRESENT_9 ... MODULE_PRESENT_16] =
	    {MODULE_PRESENT_9, XCVR_P15_P8_PRESENT_REG, 1},
	[MODULE_PRESENT_17 ... MODULE_PRESENT_24] =
	    {MODULE_PRESENT_17, XCVR_P23_P16_PRESENT_REG, 1},
	[MODULE_PRESENT_25 ... MODULE_PRESENT_32] =
	    {MODULE_PRESENT_25, XCVR_P31_P24_PRESENT_REG, 1},
	[MODULE_PRESENT_33 ... MODULE_PRESENT_40] =
	    {MODULE_PRESENT_33, XCVR_P39_P32_PRESENT_REG, 1},
	[MODULE_PRESENT_41 ... MODULE_PRESENT_48] =
	    {MODULE_PRESENT_41, XCVR_P47_P40_PRESENT_REG, 1},
	[MODULE_PRESENT_49 ... MODULE_PRESENT_56] =
	    {MODULE_PRESENT_49, XCVR_P55_P48_PRESENT_REG, 1},
	[MODULE_PRESENT_57 ... MODULE_PRESENT_64] =
	    {MODULE_PRESENT_57, XCVR_P63_P56_PRESENT_REG, 1},
	[MODULE_PRESENT_65 ... MODULE_PRESENT_66] =
	    {MODULE_PRESENT_65, SFP_PRESENT_REG, 1},

	[MODULE_LPMODE_1 ... MODULE_LPMODE_8] =
	    {MODULE_LPMODE_1, XCVR_P7_P0_LPMODE_REG, 1},
	[MODULE_LPMODE_9 ... MODULE_LPMODE_16] =
	    {MODULE_LPMODE_9, XCVR_P15_P8_LPMODE_REG, 1},
	[MODULE_LPMODE_17 ... MODULE_LPMODE_24] =
	    {MODULE_LPMODE_17, XCVR_P23_P16_LPMODE_REG, 1},
	[MODULE_LPMODE_25 ... MODULE_LPMODE_32] =
	    {MODULE_LPMODE_25, XCVR_P31_P24_LPMODE_REG, 1},
	[MODULE_LPMODE_33 ... MODULE_LPMODE_40] =
	    {MODULE_LPMODE_33, XCVR_P39_P32_LPMODE_REG, 1},
	[MODULE_LPMODE_41 ... MODULE_LPMODE_48] =
	    {MODULE_LPMODE_41, XCVR_P47_P40_LPMODE_REG, 1},
	[MODULE_LPMODE_49 ... MODULE_LPMODE_56] =
	    {MODULE_LPMODE_49, XCVR_P55_P48_LPMODE_REG, 1},
	[MODULE_LPMODE_57 ... MODULE_LPMODE_64] =
	    {MODULE_LPMODE_57, XCVR_P63_P56_LPMODE_REG, 1},

	[MODULE_RESET_1 ... MODULE_RESET_8] =
	    {MODULE_RESET_1, XCVR_P7_P0_RESET_REG, 1},
	[MODULE_RESET_9 ... MODULE_RESET_16] =
	    {MODULE_RESET_9, XCVR_P15_P8_RESET_REG, 1},
	[MODULE_RESET_17 ... MODULE_RESET_24] =
	    {MODULE_RESET_17, XCVR_P23_P16_RESET_REG, 1},
	[MODULE_RESET_25 ... MODULE_RESET_32] =
	    {MODULE_RESET_25, XCVR_P31_P24_RESET_REG, 1},
	[MODULE_RESET_33 ... MODULE_RESET_40] =
	    {MODULE_RESET_33, XCVR_P39_P32_RESET_REG, 1},
	[MODULE_RESET_41 ... MODULE_RESET_48] =
	    {MODULE_RESET_41, XCVR_P47_P40_RESET_REG, 1},
	[MODULE_RESET_49 ... MODULE_RESET_56] =
	    {MODULE_RESET_49, XCVR_P55_P48_RESET_REG, 1},
	[MODULE_RESET_57 ... MODULE_RESET_64] =
	    {MODULE_RESET_57, XCVR_P63_P56_RESET_REG, 1},

	[MODULE_TX_DISABLE_65 ... MODULE_TX_DISABLE_66] =
	    {MODULE_TX_DISABLE_65, SFP_TXDIS_REG, 0},
	[MODULE_TX_FAULT_65 ... MODULE_TX_FAULT_66] =
	    {MODULE_TX_FAULT_65, SFP_TXFAULT_REG, 0},
	[MODULE_RX_LOS_65 ... MODULE_RX_LOS_66] =
	    {MODULE_RX_LOS_65, SFP_RXLOSS_REG, 0},
};
			   ...
			   char *buf)
{
	...
	case MODULE_PRESENT_1 ... MODULE_RX_LOS_66:
		...
		if ((reg & 0xF000) == CPLD1_PCIE_START_OFFSET) {
			reg_val = fpga_read(fpga_ctl->pci_fpga_dev.data_base_addr1 +
					      reg, SPI_BUSY_MASK_CPLD1);
		} else if ((reg & 0xF000) == CPLD2_PCIE_START_OFFSET) {
			reg_val = fpga_read(fpga_ctl->pci_fpga_dev.data_base_addr2 +
					      reg, SPI_BUSY_MASK_CPLD2);
		}
		UNLOCK(&cpld_access_lock);
...
struct platform_device *ocore_i2c_device_add(unsigned int id,
...
static int as9817_64_pcie_fpga_stat_probe(struct platform_device *pdev)
{
	...
	fpga_ctl =
	    devm_kzalloc(dev, sizeof(struct as9817_64_fpga_data), GFP_KERNEL);
	if (!fpga_ctl) {
		return -ENOMEM;
	}
	...
	val = ioread8(fpga_ctl->pci_fpga_dev.data_base_addr0 +
				    FPGA_BOARD_INFO_REG);
	switch (val & 0x0C) {
	case 0x00:		/* OSFP */
	case 0x08:		/* OSFP_ROT */
	...
	fpga_ctl->pci_fpga_dev.data_region1 =
	    pci_resource_start(pcidev, BAR1_NUM) + CPLD1_PCIE_START_OFFSET;
	ret = request_mem_region(fpga_ctl->pci_fpga_dev.data_region1, REGION_LEN,
							    DRVNAME "_cpld1");
	if (ret == NULL) {
	...
	dev_info(dev, "(BAR%d resource: Start=0x%lx, Length=0x%x)", BAR1_NUM,
		 (unsigned long)fpga_ctl->pci_fpga_dev.data_region1,
		 REGION_LEN);
	...
	fpga_ctl->pci_fpga_dev.data_region2 =
	    pci_resource_start(pcidev, BAR2_NUM) + CPLD2_PCIE_START_OFFSET;
	ret = request_mem_region(fpga_ctl->pci_fpga_dev.data_region2, REGION_LEN,
							    DRVNAME "_cpld2");
	if (ret == NULL) {
		dev_err(dev, "[%s] cannot request region\n", DRVNAME "_cpld2");
		status = -EIO;
	...
	dev_info(dev, "(BAR%d resource: Start=0x%lx, Length=0x%x)", BAR2_NUM,
		 (unsigned long)fpga_ctl->pci_fpga_dev.data_region2,
		 REGION_LEN);
	...
	for (i = 0; i < PORT_NUM; i++) {
		...
		fpga_ctl->pci_fpga_dev.fpga_i2c[i] =
		    ocore_i2c_device_add((i | (port[i].mask << 8)), bar_base,
					 port[i].offset);
 ...
 exit_pci_iounmap2:
	pci_iounmap(fpga_ctl->pci_fpga_dev.pci_dev,
		    fpga_ctl->pci_fpga_dev.data_base_addr2);
 exit_pci_release1:
	release_mem_region(fpga_ctl->pci_fpga_dev.data_region1, REGION_LEN);
 exit_pci_iounmap1:
	pci_iounmap(fpga_ctl->pci_fpga_dev.pci_dev,
		    fpga_ctl->pci_fpga_dev.data_base_addr1);
 exit_pci_iounmap0:
	spi_busy_reg = NULL;
	pci_iounmap(fpga_ctl->pci_fpga_dev.pci_dev,
		    fpga_ctl->pci_fpga_dev.data_base_addr0);
 exit_pci_disable:
...
static int as9817_64_pcie_fpga_stat_remove(struct platform_device *pdev)
{
	...
	if (pci_is_enabled(fpga_ctl->pci_fpga_dev.pci_dev)) {
		...
		for (i = 0; i < PORT_NUM; i++) {
			platform_device_unregister(fpga_ctl->pci_fpga_dev.
						   fpga_i2c[i]);
		}
		spi_busy_reg = NULL;
		pci_iounmap(fpga_ctl->pci_fpga_dev.pci_dev,
		...
		release_mem_region(fpga_ctl->pci_fpga_dev.data_region1,
				   REGION_LEN);
		release_mem_region(fpga_ctl->pci_fpga_dev.data_region2,
				   REGION_LEN);
		pci_disable_device(fpga_ctl->pci_fpga_dev.pci_dev);
	}
