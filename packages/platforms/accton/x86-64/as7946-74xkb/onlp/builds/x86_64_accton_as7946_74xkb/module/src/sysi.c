...
static char* cpld_ver_path[NUM_OF_CPLD_VER] = {
    "/sys/devices/platform/as7946_74xkb_sys/cpu_cpld_ver",   /* Main CPLD */
    "/sys/devices/platform/as7946_74xkb_sys/system_cpld1_ver", /* System CPLD */
    "/sys/devices/platform/as7946_74xkb_sys/fan_cpld_ver", /* Fan CPLD */
};

const char*
onlp_sysi_platform_get(void)
{
    return "x86-64-accton-as7946-74xkb-r0";
}
