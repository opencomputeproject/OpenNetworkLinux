...
#undef __powerpc_accton_as5710_54x_config_STRINGIFY_NAME

const char*
powerpc_accton_as5710_54x_config_lookup(const char* setting)
{
    int i;
    for(i = 0; powerpc_accton_as5710_54x_config_settings[i].name; i++) {
        if(!strcmp(powerpc_accton_as5710_54x_config_settings[i].name, setting)) {
            return powerpc_accton_as5710_54x_config_settings[i].value;
        }
    }
    return NULL;
}
...
int
powerpc_accton_as5710_54x_config_show(struct aim_pvs_s* pvs)
{
    int i;
    for(i = 0; powerpc_accton_as5710_54x_config_settings[i].name; i++) {
        aim_printf(pvs, "%s = %s\n", powerpc_accton_as5710_54x_config_settings[i].name, powerpc_accton_as5710_54x_config_settings[i].value);
    }
    return i;
}
