...
x86_64_delta_agc5648s_ucli_module__ =
{
    "x86_64_delta_agc5648s_ucli",
    NULL,
    x86_64_delta_agc5648s_ucli_ucli_handlers__,
    NULL,
    NULL,
};

ucli_node_t*
x86_64_delta_agc5648s_ucli_node_create(void)
{
    ucli_node_t* n;
    ucli_module_init(&x86_64_delta_agc5648s_ucli_module__);
    n = ucli_node_create("x86_64_delta_agc5648s", NULL, &x86_64_delta_agc5648s_ucli_module__);
    ucli_node_subnode_add(n, ucli_module_log_node_create("x86_64_delta_agc5648s"));
    return n;
}
