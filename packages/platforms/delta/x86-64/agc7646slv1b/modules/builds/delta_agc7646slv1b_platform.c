...
#define agc7646slv1b_i2c_device_num(NUM){    \
    .name = "delta-agc7646slv1b-i2c-device", \
    .id   = NUM,                           \
    .dev  = {                              \
        .platform_data = &agc7646slv1b_i2c_device_platform_data[NUM], \
...
enum agc7646slv1b_sfp_sysfs_attributes 
{
    SFP_SELECT_PORT,
    SFP_IS_PRESENT,
    SFP_IS_PRESENT_ALL,
...
static struct cpld_platform_data agc7646slv1b_cpld_platform_data[] = {
    [system_cpld] = {
        .reg_addr = CPUPLD_ADDR,
    },
};

static struct cpld_platform_data agc7646slv1b_swpld1_platform_data[] = {
    [swpld1] = {
        .reg_addr = SWPLD1_ADDR,
    },
};

static struct cpld_platform_data agc7646slv1b_swpld2_platform_data[] = {
    [swpld2] = {
        .reg_addr = SWPLD2_ADDR,
    },
};

static struct cpld_platform_data agc7646slv1b_swpld3_platform_data[] = {
    [swpld3] = {
...
/* ---------------- I2C device - start ------------- */
static struct i2c_device_platform_data agc7646slv1b_i2c_device_platform_data[] = {
    {
        // id eeprom
        .parent = 1,
...
static struct platform_device agc7646slv1b_i2c_device[] = {
    agc7646slv1b_i2c_device_num(0),
    agc7646slv1b_i2c_device_num(1),
    agc7646slv1b_i2c_device_num(2),
    agc7646slv1b_i2c_device_num(3),
    agc7646slv1b_i2c_device_num(4),
    agc7646slv1b_i2c_device_num(5),
    agc7646slv1b_i2c_device_num(6),
    agc7646slv1b_i2c_device_num(7),
    agc7646slv1b_i2c_device_num(8),
    agc7646slv1b_i2c_device_num(9),
    agc7646slv1b_i2c_device_num(10),
    agc7646slv1b_i2c_device_num(11),
    agc7646slv1b_i2c_device_num(12),
    agc7646slv1b_i2c_device_num(13),
    agc7646slv1b_i2c_device_num(14),
    agc7646slv1b_i2c_device_num(15),
    agc7646slv1b_i2c_device_num(16),
    agc7646slv1b_i2c_device_num(17),
    agc7646slv1b_i2c_device_num(18),
    agc7646slv1b_i2c_device_num(19),
    agc7646slv1b_i2c_device_num(20),
    agc7646slv1b_i2c_device_num(21),
    agc7646slv1b_i2c_device_num(22),
    agc7646slv1b_i2c_device_num(23),
    agc7646slv1b_i2c_device_num(24),
    agc7646slv1b_i2c_device_num(25),
    agc7646slv1b_i2c_device_num(26),
    agc7646slv1b_i2c_device_num(27),
    agc7646slv1b_i2c_device_num(28),
    agc7646slv1b_i2c_device_num(29),
    agc7646slv1b_i2c_device_num(30),
    agc7646slv1b_i2c_device_num(31),
    agc7646slv1b_i2c_device_num(32),
    agc7646slv1b_i2c_device_num(33),
    agc7646slv1b_i2c_device_num(34),
    agc7646slv1b_i2c_device_num(35),
    agc7646slv1b_i2c_device_num(36),
    agc7646slv1b_i2c_device_num(37),
    agc7646slv1b_i2c_device_num(38),
    agc7646slv1b_i2c_device_num(39),
    agc7646slv1b_i2c_device_num(40),
    agc7646slv1b_i2c_device_num(41),
    agc7646slv1b_i2c_device_num(42),
    agc7646slv1b_i2c_device_num(43),
    agc7646slv1b_i2c_device_num(44),
    agc7646slv1b_i2c_device_num(45),
    agc7646slv1b_i2c_device_num(46),
    agc7646slv1b_i2c_device_num(47),
    agc7646slv1b_i2c_device_num(48),
    agc7646slv1b_i2c_device_num(49),
    agc7646slv1b_i2c_device_num(50),
    agc7646slv1b_i2c_device_num(51),
    agc7646slv1b_i2c_device_num(52),
    agc7646slv1b_i2c_device_num(53),
    agc7646slv1b_i2c_device_num(54),
    agc7646slv1b_i2c_device_num(55),
    agc7646slv1b_i2c_device_num(56),
    agc7646slv1b_i2c_device_num(57),
    agc7646slv1b_i2c_device_num(58),
    agc7646slv1b_i2c_device_num(59),
    agc7646slv1b_i2c_device_num(60),
    agc7646slv1b_i2c_device_num(61),
...
static struct platform_device cpld_device = {
    .name = "delta-agc7646slv1b-cpld",
    .id   = 0,
    .dev = {
        .platform_data  = agc7646slv1b_cpld_platform_data,
        .release        = device_release
    },
};

static struct platform_device swpld1_device = {
    .name = "delta-agc7646slv1b-swpld1",
    .id   = 0,
    .dev  = {
        .platform_data = agc7646slv1b_swpld1_platform_data,
        .release       = device_release
    },
};

static struct platform_device swpld2_device = {
    .name = "delta-agc7646slv1b-swpld2",
    .id   = 0,
    .dev  = {
        .platform_data  = agc7646slv1b_swpld2_platform_data,
        .release        = device_release
    },
};

static struct platform_device swpld3_device = {
    .name               = "delta-agc7646slv1b-swpld3",
    .id                 = 0,
    .dev                = {
                .platform_data   = agc7646slv1b_swpld3_platform_data,
                .release         = device_release
    },
};
...
static struct cpld_mux_platform_data agc7646slv1b_cpld_mux_platform_data[] = {
    {
        .parent         = BUS0,
...
static struct cpld_mux_platform_data agc7646slv1b_swpld1_mux_platform_data[] = {
    {
        .parent         = BUS5,
...
static struct cpld_mux_platform_data agc7646slv1b_swpld3_mux_platform_data[] = {
    {
        .parent         = BUS2,
...
{
    {
        .name           = "delta-agc7646slv1b-cpld-mux",
        .id             = 0,
        .dev            = {
                .platform_data   = &agc7646slv1b_cpld_mux_platform_data[0],
                .release         = device_release,
        },
    },
};
...
{
    {
        .name = "delta-agc7646slv1b-swpld1-mux",
        .id   = 0,
        .dev  = {
            .platform_data = &agc7646slv1b_swpld1_mux_platform_data[0],
            .release       = device_release,
        },
    },
    {
        ...
        .id   = 1,
        .dev  = {
            .platform_data = &agc7646slv1b_swpld1_mux_platform_data[1],
            .release       = device_release,
        },
    },
};
...
{
    {
        .name = "delta-agc7646slv1b-swpld3-mux",
        .id   = 0,
        .dev  = {
            .platform_data  = &agc7646slv1b_swpld3_mux_platform_data[0],
            .release        = device_release,
        },
    },
    {
        ...
        .id   = 1,
        .dev  = {
            .platform_data  = &agc7646slv1b_swpld3_mux_platform_data[1],
            .release        = device_release,
        },
    },
};
...
static int __init delta_agc7646slv1b_platform_init(void)
{
//    struct i2c_client *client;
    ...
    mutex_init(&dni_lock);
    printk("agc7646slv1b_platform module initialization\n");
    ...
    cpld_pdata = agc7646slv1b_cpld_platform_data;
    ...
    swpld1_pdata = agc7646slv1b_swpld1_platform_data;
    for (i = 0; i < ARRAY_SIZE(swpld1_mux_device); i++)
    {
        ...
        if (ret) {
            ...
            goto error_agc7646slv1b_swpld1_mux;
        }
    }

    // link the SWPLD3 and the Mux
    swpld3_pdata = agc7646slv1b_swpld3_platform_data;
    for (i = 0; i < ARRAY_SIZE(swpld3_mux_device); i++)
    {
        ...
        if (ret) {
            ...
            goto error_agc7646slv1b_swpld3_mux;
        }
    }

    for (i = 0; i < ARRAY_SIZE(agc7646slv1b_i2c_device); i++)
    {
        ret = platform_device_register(&agc7646slv1b_i2c_device[i]);
        if (ret) 
        {
            printk(KERN_WARNING "Fail to create i2c device %d\n", i);
            goto error_agc7646slv1b_i2c_device;
        }
    }
    if (ret)
        goto error_cpld_mux;
...
error_agc7646slv1b_i2c_device:
    i--;
    for (; i >= 0; i--) {
        platform_device_unregister(&agc7646slv1b_i2c_device[i]);
    }
    i = ARRAY_SIZE(swpld3_mux_device);
error_agc7646slv1b_swpld3_mux:
    i--;
    for (; i >= 0; i--) {
        platform_device_unregister(&swpld3_mux_device[i]);
    }
    i = ARRAY_SIZE(swpld1_mux_device);
error_agc7646slv1b_swpld1_mux:
    i--;
    for (; i >= 0; i--) {
...
static void __exit delta_agc7646slv1b_platform_exit(void)
{
    int i = 0;
...
module_init(delta_agc7646slv1b_platform_init);
