...
vendor_dev_t thermal_dev_list[] =
{
    ...
    {"FAN_Temp",   THERMAL_SENSOR, THERMAL_2_ON_FAN_BOARD,         0},
    {"Temp_1",     THERMAL_SENSOR, THERMAL_3_ON_MAIN_BOARD_TEMP_1, 0},
    {"Temp_2",     THERMAL_SENSOR, THERMAL_4_ON_MAIN_BOARD_TEMP_2, 0},
    {"Temp_3",     THERMAL_SENSOR, THERMAL_5_ON_MAIN_BOARD_TEMP_3, 0},
    {"Temp_4",     THERMAL_SENSOR, THERMAL_6_ON_MAIN_BOARD_TEMP_4, 0},
    {"PSU1_Temp1", THERMAL_SENSOR, THERMAL_7_ON_PSU1,              0},
    {"PSU2_Temp1", THERMAL_SENSOR, THERMAL_8_ON_PSU2,              0}
};

vendor_dev_t fan_dev_list[] =
{
    {"",         FAN_SENSOR, FAN_RESERVED,       0},
    {"FAN_1-1",  FAN_SENSOR, FAN_1_ON_FAN_BOARD, 0},
    {"FAN_1-2",  FAN_SENSOR, FAN_2_ON_FAN_BOARD, 0},
    {"FAN_1-3",  FAN_SENSOR, FAN_3_ON_FAN_BOARD, 0},
    {"FAN_1-4",  FAN_SENSOR, FAN_4_ON_FAN_BOARD, 0},
    {"FAN_2-1",  FAN_SENSOR, FAN_6_ON_FAN_BOARD, 0},
    {"FAN_2-2",  FAN_SENSOR, FAN_7_ON_FAN_BOARD, 0},
    {"FAN_2-3",  FAN_SENSOR, FAN_8_ON_FAN_BOARD, 0},
    {"FAN_2-4",  FAN_SENSOR, FAN_9_ON_FAN_BOARD, 0},
    {"PSU1_FAN", FAN_SENSOR, FAN_1_ON_PSU1,      0},
    {"PSU2_FAN", FAN_SENSOR, FAN_1_ON_PSU2,      0}
};

vendor_dev_t psu_dev_list[] =
{
    {"",          PSU_SENSOR, PSU_RESERVED, 0},
    {"PSU1_Vin",  PSU_SENSOR, PSU1_ID,      0},
    {"PSU1_Vout", PSU_SENSOR, PSU1_ID,      0},
    {"PSU1_Iin",  PSU_SENSOR, PSU1_ID,      0},
    {"PSU1_Iout", PSU_SENSOR, PSU1_ID,      0},
    {"PSU1_Pin",  PSU_SENSOR, PSU1_ID,      0},
    {"PSU1_Pout", PSU_SENSOR, PSU1_ID,      0},
    {"PSU2_Vin",  PSU_SENSOR, PSU2_ID,      0},
    {"PSU2_Vout", PSU_SENSOR, PSU2_ID,      0},
    {"PSU2_Iin",  PSU_SENSOR, PSU2_ID,      0},
    {"PSU2_Iout", PSU_SENSOR, PSU2_ID,      0},
    {"PSU2_Pin",  PSU_SENSOR, PSU2_ID,      0},
    {"PSU2_Pout", PSU_SENSOR, PSU2_ID,      0}
};
