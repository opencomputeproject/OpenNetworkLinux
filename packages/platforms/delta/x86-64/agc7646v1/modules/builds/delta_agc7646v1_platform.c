...
enum agc7646v1_sfp_sysfs_attributes 
{
    SFP_SELECT_PORT,
    SFP_IS_PRESENT,
    SFP_IS_PRESENT_ALL,
...
static struct cpld_platform_data agc7646v1_swpld1_platform_data[] = {
    [swpld1] = {
        .reg_addr = SWPLD1_ADDR,
    },
};

static struct cpld_platform_data agc7646v1_swpld2_platform_data[] = {
    [swpld2] = {
        .reg_addr = SWPLD2_ADDR,
    },
};

static struct cpld_platform_data agc7646v1_swpld3_platform_data[] = {
    [swpld3] = {
...
static struct i2c_device_platform_data agc7646v1_i2c_device_platform_data[] = {
    ...
    },
    {
        // PSU 1 control
        .parent = 31,
        .info = { I2C_BOARD_INFO("agc7646v1_psu", 0x58) },
        .client = NULL,
    },
    {
        // PSU 2 control
...
static struct platform_device agc7646v1_i2c_device[] = {
    ...
    agc7646v1_i2c_device_num(53),
    agc7646v1_i2c_device_num(54),
    agc7646v1_i2c_device_num(55),
    agc7646v1_i2c_device_num(56),
    agc7646v1_i2c_device_num(57),
    agc7646v1_i2c_device_num(58),
    agc7646v1_i2c_device_num(59),
    agc7646v1_i2c_device_num(60),
    agc7646v1_i2c_device_num(61),
    agc7646v1_i2c_device_num(62),
    agc7646v1_i2c_device_num(63),
    agc7646v1_i2c_device_num(64),
};
/* ---------------- I2C device - end ------------- */
...
static struct platform_device swpld1_device = {
    .name = "delta-agc7646v1-swpld1",
    .id   = 0,
    .dev  = {
        .platform_data = agc7646v1_swpld1_platform_data,
        .release       = device_release
    },
};

static struct platform_device swpld2_device = {
    .name = "delta-agc7646v1-swpld2",
    .id   = 0,
    .dev  = {
        .platform_data  = agc7646v1_swpld2_platform_data,
        .release        = device_release
    },
};

static struct platform_device swpld3_device = {
    .name               = "delta-agc7646v1-swpld3",
    .id                 = 0,
    .dev                = {
                .platform_data   = agc7646v1_swpld3_platform_data,
                .release         = device_release
    },
};
...
static struct cpld_mux_platform_data agc7646v1_swpld1_mux_platform_data[] = {
    {
        .parent         = BUS5,
...
{
    {
        .name = "delta-agc7646v1-swpld1-mux",
        .id   = 0,
        .dev  = {
            .platform_data = &agc7646v1_swpld1_mux_platform_data[0],
            .release       = device_release,
        },
    },
    {
        ...
        .id   = 1,
        .dev  = {
            .platform_data = &agc7646v1_swpld1_mux_platform_data[1],
            .release       = device_release,
        },
    },
};
...
//    struct i2c_client *client;
    ...
    swpld1_pdata = agc7646v1_swpld1_platform_data;
    for (i = 0; i < ARRAY_SIZE(swpld1_mux_device); i++)
    {
        ...
        if (ret) {
            ...
            goto error_agc7646v1_swpld1_mux;
        }
    }

    // link the SWPLD3 and the Mux
    swpld3_pdata = agc7646v1_swpld3_platform_data;
