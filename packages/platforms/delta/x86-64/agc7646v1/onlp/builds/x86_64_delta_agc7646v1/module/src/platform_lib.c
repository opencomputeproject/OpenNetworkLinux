...
vendor_dev_t fan_dev_list[] =
{
    ...
    {"Fantray_1_1", FAN_SENSOR, FAN_1_ON_FAN_BOARD, 0},
    {"Fantray_1_2", FAN_SENSOR, FAN_2_ON_FAN_BOARD, 0},
    {"Fantray_1_3", FAN_SENSOR, FAN_3_ON_FAN_BOARD, 0},
    {"Fantray_1_4", FAN_SENSOR, FAN_4_ON_FAN_BOARD, 0},
    {"Fantray_2_1", FAN_SENSOR, FAN_5_ON_FAN_BOARD, 0},
    {"Fantray_2_2", FAN_SENSOR, FAN_6_ON_FAN_BOARD, 0},
    {"Fantray_2_3", FAN_SENSOR, FAN_7_ON_FAN_BOARD, 0},
    {"Fantray_2_4", FAN_SENSOR, FAN_8_ON_FAN_BOARD, 0},
...
int dni_bmc_psueeprom_info_get(char * r_data, char *device_name, int number)
{
    ...
    char file_path[VENDOR_MAX_CMD_SIZE] = {0};
    char buf;
    char* renewCh;
    ...
    if (ipmi_data_update == 1)
    {
        ...
        for (psu_num = 1; psu_num < 3; psu_num++)
        {
            ...
            {
                sprintf(get_cmd, "cat /tmp/psu%d_eeprom | grep '%s' | awk -F':' '{print $2}'", psu_num, psu_eeprom_info_table[psu_num-1].psu_eeprom_table[table_num].name);
