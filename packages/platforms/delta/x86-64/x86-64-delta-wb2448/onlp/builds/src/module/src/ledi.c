...
{
	{LED_PWR1, LED_MODE_OFF,   ONLP_LED_MODE_OFF},
	{LED_PWR1, LED_MODE_GREEN, ONLP_LED_MODE_GREEN},
	{LED_PWR1, LED_MODE_RED,   ONLP_LED_MODE_RED},
	{LED_PWR2, LED_MODE_OFF,   ONLP_LED_MODE_OFF},
	{LED_PWR2, LED_MODE_GREEN, ONLP_LED_MODE_GREEN},
	{LED_PWR2, LED_MODE_RED,   ONLP_LED_MODE_RED},
...
static onlp_led_info_t linfo[] =
{
    { },
    {
        { ONLP_LED_ID_CREATE(LED_PWR1), "Chassis LED 1 (PWR1)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED,
    },
    {
        { ONLP_LED_ID_CREATE(LED_PWR2), "Chassis LED 2 (PWR2)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED,
    },
    {
        { ONLP_LED_ID_CREATE(LED_SYSTEM), "Chassis LED 3 (SYSTEM)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_GREEN_BLINKING | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED | ONLP_LED_CAPS_RED_BLINKING,
    },
    {
        { ONLP_LED_ID_CREATE(LED_FAN), "Chassis LED 4 (FAN)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED,
    },
    {
        { ONLP_LED_ID_CREATE(LED_TEMP), "Chassis LED 5 (TEMP)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED,
    },
};
...
onlp_ledi_info_get(onlp_oid_t id, onlp_led_info_t* info)
{
    ...
    *info = linfo[ONLP_OID_ID_GET(id)];	
    ...
    {
        case LED_PWR1:
            rv = ifnOS_LINUX_BmcI2CGet(I2C_BUS, CPLD_ADDR, PWR_LED_REGISTER, LED_ADDR_LEN, &u4LedMode, LED_DATA_LEN);
...
onlp_ledi_mode_set(onlp_oid_t id, onlp_led_mode_t mode)
{
    ...
    {
        case LED_PWR1:
            u4Addr = PWR_LED_REGISTER;
            rv = ifnOS_LINUX_BmcI2CGet(I2C_BUS, CPLD_ADDR, u4Addr, LED_ADDR_LEN, &u4OldLedMode, LED_DATA_LEN);
            u4NewLedMode = ( (u4OldLedMode & 0x30) | ((driver_led_mode << 6) & 0xC0) );
            break;
            
        case LED_PWR2:
            u4Addr = PWR_LED_REGISTER;
            rv = ifnOS_LINUX_BmcI2CGet(I2C_BUS, CPLD_ADDR, u4Addr, LED_ADDR_LEN, &u4OldLedMode, LED_DATA_LEN);
            u4NewLedMode = ( (u4OldLedMode & 0xC0) | ((driver_led_mode << 4) & 0x30) );
            break;
