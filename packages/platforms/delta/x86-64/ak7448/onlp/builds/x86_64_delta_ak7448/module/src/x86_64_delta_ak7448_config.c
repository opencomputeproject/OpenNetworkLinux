...
#undef __x86_64_delta_ak7448_config_STRINGIFY_VALUE
#undef __x86_64_delta_ak7448_config_STRINGIFY_NAME

const char*
x86_64_delta_ak7448_config_lookup(const char* setting)
{
    int i;
...
int
x86_64_delta_ak7448_config_show(struct aim_pvs_s* pvs)
{
    int i;
    for(i = 0; x86_64_delta_ak7448_config_settings[i].name; i++) {
        aim_printf(pvs, "%s = %s\n", x86_64_delta_ak7448_config_settings[i].name, x86_64_delta_ak7448_config_settings[i].value);
    }
    return i;
}
