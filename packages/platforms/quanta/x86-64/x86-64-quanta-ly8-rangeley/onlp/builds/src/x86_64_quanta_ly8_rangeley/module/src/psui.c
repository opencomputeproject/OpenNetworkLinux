...
struct psu_info_s psu_info[] = {
	{}, /* Not used */
	{ .path = "/sys/devices/pci0000:00/0000:00:1f.3/i2c-0/i2c-24/24-006f", .present = QUANTA_LY8_PSU_GPIO_PSU1_PRSNT_N, .busno = 24, .addr = 0x6f},
	{ .path = "/sys/devices/pci0000:00/0000:00:1f.3/i2c-0/i2c-25/25-0069", .present = QUANTA_LY8_PSU_GPIO_PSU2_PRSNT_N, .busno = 25, .addr = 0x69},
};
