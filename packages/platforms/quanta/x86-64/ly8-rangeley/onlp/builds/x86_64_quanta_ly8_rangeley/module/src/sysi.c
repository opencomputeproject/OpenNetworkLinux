...
onlp_sysi_init(void)
{
    ...
    /* Config GPIO */
    /* LED Output */
    onlp_gpio_export(QUANTA_LY8_CPU_BOARD_SYS_P1, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_CPU_BOARD_SYS_P2, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_PSU1_GREEN_R, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_PSU1_RED_R, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_PSU2_GREEN_R, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_PSU2_RED_R, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_FAN_FAIL_LED_1, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_FAN_FAIL_LED_2, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_FAN_FAIL_LED_3, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_FAN_GREEN_R, ONLP_GPIO_DIRECTION_OUT);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_FAN_RED_R, ONLP_GPIO_DIRECTION_OUT);
    /* PSU Input */
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_PSU1_PRSNT_N, ONLP_GPIO_DIRECTION_IN);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_PSU1_PWRGD, ONLP_GPIO_DIRECTION_IN);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_PSU2_PRSNT_N, ONLP_GPIO_DIRECTION_IN);
    onlp_gpio_export(QUANTA_LY8_PSU_GPIO_PSU2_PWRGD, ONLP_GPIO_DIRECTION_IN);
    /* FAN Input */
    onlp_gpio_export(QUANTA_LY8_FAN_PRSNT_N_1, ONLP_GPIO_DIRECTION_IN);
    onlp_gpio_export(QUANTA_LY8_FAN_PRSNT_N_2, ONLP_GPIO_DIRECTION_IN);
    onlp_gpio_export(QUANTA_LY8_FAN_PRSNT_N_3, ONLP_GPIO_DIRECTION_IN);
    /* FAN Direction */
    onlp_gpio_export(QUANTA_LY8_FAN_BF_DET1, ONLP_GPIO_DIRECTION_IN);
    onlp_gpio_export(QUANTA_LY8_FAN_BF_DET2, ONLP_GPIO_DIRECTION_IN);
    onlp_gpio_export(QUANTA_LY8_FAN_BF_DET3, ONLP_GPIO_DIRECTION_IN);
