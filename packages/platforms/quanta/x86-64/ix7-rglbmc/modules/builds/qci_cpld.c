...
#define TYPE_SFP            "sfp"
#define TYPE_QSFP           "qsfp"
#define TYPE_QSFP28         "qsfp28"
#define CLASS_CPLD_SFP      "cpld-sfp"
#define CLASS_CPLD_QSFP     "cpld-qsfp"
#define CLASS_CPLD_QSFP28   "cpld-qsfp28"
...
//	struct device *i2c_dev;
	...
	if (!cpld_class)
	{
		switch(id->driver_data)
		{
			...
			case QSFP:
				cpld_class = class_create(THIS_MODULE, CLASS_CPLD_QSFP);
				break;

			case QSFP28:
				cpld_class = class_create(THIS_MODULE, CLASS_CPLD_QSFP28);
				break;
	...
	for (i = 0; i < max_port_num; i++)
	{
		...
		else if (QSFP == id->driver_data)
		{
			strcpy(port_data->type, TYPE_QSFP);
		}
		else if (QSFP28 == id->driver_data)
		{
			strcpy(port_data->type, TYPE_QSFP28);
		}
