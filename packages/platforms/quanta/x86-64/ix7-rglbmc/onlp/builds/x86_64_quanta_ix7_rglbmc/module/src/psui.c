...
sys_psu_info_get__(onlp_psu_info_t* info, int id)
{
	...
	{
		sprintf(info->hdr.description, "Quanta IX7 RPSU-1");

		fan_id = QUANTA_IX7_PSU1_FAN_ID;
		pin_id = QUANTA_IX7_PSU1_PIN_ID, pout_id = QUANTA_IX7_PSU1_POUT_ID;
		vin_id = QUANTA_IX7_PSU1_VIN_ID, vout_id = QUANTA_IX7_PSU1_VOUT_ID;
		cin_id = QUANTA_IX7_PSU1_CIN_ID, cout_id = QUANTA_IX7_PSU1_COUT_ID;
		temp1_id = QUANTA_IX7_PSU1_TEMP1_ID, temp2_id = QUANTA_IX7_PSU1_TEMP2_ID, temp3_id = QUANTA_IX7_PSU1_TEMP3_ID;
	}
	else if (id == PSU_OID_PSU102)
	{
		sprintf(info->hdr.description, "Quanta IX7 RPSU-2");

		fan_id = QUANTA_IX7_PSU2_FAN_ID;
		pin_id = QUANTA_IX7_PSU2_PIN_ID, pout_id = QUANTA_IX7_PSU2_POUT_ID;
		vin_id = QUANTA_IX7_PSU2_VIN_ID, vout_id = QUANTA_IX7_PSU2_VOUT_ID;
		cin_id = QUANTA_IX7_PSU2_CIN_ID, cout_id = QUANTA_IX7_PSU2_COUT_ID;
		temp1_id = QUANTA_IX7_PSU2_TEMP1_ID, temp2_id = QUANTA_IX7_PSU2_TEMP2_ID, temp3_id = QUANTA_IX7_PSU2_TEMP3_ID;
	}
	else
	{
