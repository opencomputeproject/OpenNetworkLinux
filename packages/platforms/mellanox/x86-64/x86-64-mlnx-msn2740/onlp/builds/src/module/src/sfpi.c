...
static int
msn2740_sfp_node_read_int(char *node_path, int *value)
{
...
static char*
msn2740_sfp_get_port_path(int port, char *node_name)
{
...
static char*
sn2740_sfp_convert_i2c_path(int port, int devaddr)
{
...
onlp_sfpi_is_present(int port)
{
     ...
     */
    int present = -1;
    char* path = msn2740_sfp_get_port_path(port, "_status");

    if (msn2740_sfp_node_read_int(path, &present) != 0) {
...
{
    char* path = msn2740_sfp_get_port_path(port, "");
