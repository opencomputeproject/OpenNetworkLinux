...
#define SYS_FAN_PREFIX "/sys/class/hwmon/hwmon9/device/"
#define SYS_HWMON_TEMP_PREFIX "/sys/class/hwmon/hwmon1/device/"

#define SYS_HWMON_TEMP1_INPUT_PREFIX "/sys/class/hwmon/hwmon%d/temp1_input"

#define SYS_HWMON_PSU1_PREFIX "/sys/class/hwmon/hwmon7/device/"
#define SYS_HWMON_PSU2_PREFIX "/sys/class/hwmon/hwmon8/device/"

#define SYS_CPLD_QSFP_PRES_PREFIX "/sys/bus/i2c/devices/%d-0033/cpld_qsfp_port_status_%d"
...
#define I2C_BUS_8               8  
#define I2C_BUS_9               9
#define I2C_BUS_10              10
#define I2C_BUS_11              11
#define I2C_BUS_12              12
#define I2C_BUS_13              13
#define I2C_BUS_14              14
#define I2C_BUS_15              15
#define I2C_BUS_16              16
#define I2C_BUS_17              17
#define I2C_BUS_18              18
#define I2C_BUS_19              19
#define I2C_BUS_20              20
...
typedef enum thermal_oid_e {
    THERMAL_OID_REAR_PANEL = ONLP_THERMAL_ID_CREATE(1),
    THERMAL_OID_REAR_MAC = ONLP_THERMAL_ID_CREATE(2),
    THERMAL_OID_FRONT_PANEL = ONLP_THERMAL_ID_CREATE(3),    
    THERMAL_OID_FRONT_MAC = ONLP_THERMAL_ID_CREATE(4),    
...
typedef enum thermal_id_e {
    THERMAL_ID_REAR_PANEL = 1,
    THERMAL_ID_REAR_MAC = 2,
    THERMAL_ID_FRONT_PANEL = 3,
    THERMAL_ID_FRONT_MAC = 4,
    THERMAL_ID_CPU1 = 5,
    THERMAL_ID_CPU2 = 6,
    THERMAL_ID_CPU3 = 7,
    THERMAL_ID_CPU4 = 8,
    THERMAL_ID_PSU1_1 = 9,
    THERMAL_ID_PSU1_2 = 10,
    THERMAL_ID_PSU2_1 = 11,
    THERMAL_ID_PSU2_2 = 12,
} thermal_id_t;
