...
static onlp_thermal_info_t thermal_info[] = {
    { }, /* Not used */
    { { THERMAL_OID_REAR_PANEL, "Chassis Thermal (Rear Panel)", 0},
                ONLP_THERMAL_STATUS_PRESENT,
                ONLP_THERMAL_CAPS_ALL, 0, THERMAL_THRESHOLD_INIT_DEFAULTS
    },
    { { THERMAL_OID_REAR_MAC, "Chassis Thermal (Rear MAC)", 0},
                ONLP_THERMAL_STATUS_PRESENT,
                ONLP_THERMAL_CAPS_ALL, 0, THERMAL_THRESHOLD_INIT_DEFAULTS
    },
    { { THERMAL_OID_FRONT_PANEL, "Chassis Thermal (Front Panel)", 0},
                ONLP_THERMAL_STATUS_PRESENT,
                ONLP_THERMAL_CAPS_ALL, 0, THERMAL_THRESHOLD_INIT_DEFAULTS
    },
    { { THERMAL_OID_FRONT_MAC, "Chassis Thermal (Front MAC)", 0},
                ONLP_THERMAL_STATUS_PRESENT,
                ONLP_THERMAL_CAPS_ALL, 0, THERMAL_THRESHOLD_INIT_DEFAULTS
    },
...
sys_thermal_info_get(onlp_thermal_info_t* info, int id)
{
    ...
    rv = onlp_file_read_int(&info->mcelsius,
                            SYS_HWMON_TEMP1_INPUT_PREFIX, id);
