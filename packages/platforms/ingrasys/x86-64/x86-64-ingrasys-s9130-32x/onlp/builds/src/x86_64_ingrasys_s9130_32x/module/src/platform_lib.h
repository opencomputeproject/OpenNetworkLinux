...
#include "x86_64_ingrasys_s9130_32x_int.h"
...
#define SYS_FAN_PREFIX "/sys/class/hwmon/hwmon5/device/"
...
#define SYS_HWMON_PSU2_PREFIX "/sys/class/hwmon/hwmon6/device/"

#define SYS_EEPROM_PATH "/sys/bus/i2c/devices/0-0055/eeprom"
#define PSU1_EEPROM_PATH "/sys/bus/i2c/devices/9-0050/psu_eeprom"
#define PSU2_EEPROM_PATH "/sys/bus/i2c/devices/10-0050/psu_eeprom"
...
typedef enum thermal_oid_e {
    THERMAL_OID_REAR_MAC = ONLP_THERMAL_ID_CREATE(1),
    THERMAL_OID_FRONT_MAC = ONLP_THERMAL_ID_CREATE(2),
    THERMAL_OID_BB_MAC = ONLP_THERMAL_ID_CREATE(3),    
    THERMAL_OID_CB_MAC = ONLP_THERMAL_ID_CREATE(4),    
...
typedef enum thermal_id_e {
    THERMAL_ID_REAR_MAC = 1,
    THERMAL_ID_FRONT_MAC = 2,
    THERMAL_ID_BB_MAC = 3,
    THERMAL_ID_CB_MAC = 4,
    THERMAL_ID_CPU1 = 5,
    THERMAL_ID_CPU2 = 6,
